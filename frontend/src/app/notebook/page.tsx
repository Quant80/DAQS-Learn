  ...
  return (
    <div className="flex flex-col h-screen bg-[#0a0a10]">
      ...
      <div className="h-10 bg-[#0d0d18] border-b border-white/8 flex items-center px-3 gap-3 shrink-0">
        <div className="w-5 h-5 rounded bg-emerald-600/20 border border-emerald-500/30 flex items-center justify-center text-[10px]">📓</div>
        <span className="text-emerald-300 text-xs font-semibold">JupyterLite</span>
        ...
        <div className="ml-auto flex items-center gap-2">
          <a
            ...
            className="text-xs text-emerald-400/70 hover:text-emerald-300 border border-emerald-500/20 hover:border-amber-500/40 rounded-lg px-2.5 py-1 transition-all"
          >
            Open tab ↗
          </a>
          <Link
            href="/dashboard/notebook"
            className="flex items-center gap-1.5 text-xs text-emerald-400 hover:text-emerald-300 border border-emerald-500/25 hover:border-emerald-500/50 bg-emerald-500/5 hover:bg-emerald-500/10 rounded-lg px-3 py-1.5 transition-all"
          >
